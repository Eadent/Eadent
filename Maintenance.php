...
// $Revision: $
//
// Created:	Eamonn A. Duffy, 3-Oct-2009. [C#]
//          Eamonn A. Duffy, 3-Jun-2010. [PHP]
//
// Purpose:	Maintenance web page.
//
//---------------------------------------------------------------------------
    ...
    {
            if (strcasecmp($Key, "DurationMessage") == 0)
        {
            $DurationMessage = $Value;  // TODO: Determine if have to change to non-encoded string (e.g. %20 malarkey)?
            break;
        }
    }

    if (! $DurationMessage)
        $DurationMessage = Configuration::GetMaintenanceDurationMessage();
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        ...
        <title>Eadent - Maintenance</title>
...
?>
		<div id="Middle">
		<h4 style="color: green;">Maintenance</h4>
		<p>
		The Web Site is currently unavailable due to maintenance.
		</p>
		<p>
		<?php echo $DurationMessage; ?>
		</p>
